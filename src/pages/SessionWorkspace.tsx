    ...
    const handleAudioFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            toast({
                ...
                description: `El archivo ${file.name} ha sido adjuntado.`,
            });
        }
    };
    ...
    const handleGenerateReport = async () => {
        ...
        if (!audioBlob) {
            toast({
                ...
                description: "Por favor, graba o adjunta una sesión antes de generar un informe.",
                variant: "destructive",
            });
            setIsLoading(false);
            return;
        ...
        try {
            ...
            toast({
                ...
                description: (error as Error).message || "Ocurrió un error inesperado. Revisa la consola para más detalles.",
                variant: "destructive",
            });
        } finally {
            setIsLoading(false);
    ...
    const handleSaveDraft = async () => {
        if (!notes.trim() && !audioBlob) {
            toast({
                ...
                description: "No hay notas ni audio para guardar como borrador.",
                variant: "destructive",
            });
            return;
        }
        ...
        try {
            ...
            if (audioBlob) {
                const fileName = `${session.user.id}/${new Date().toISOString()}`;
            ...
            if (insertError) throw new Error(`Error al guardar el borrador: ${insertError.message}`);

            toast({
                title: "Borrador Guardado",
                description: "Tu sesión ha sido guardada en la nube.",
            });
        ...
        <div className="container mx-auto max-w-4xl p-6 space-y-8">
            ...
            <Card className="bg-white shadow-lg">
                ...
                <CardContent className="flex flex-col items-center space-y-6 pt-6">
                    {!isRecording ? (
                        <Button size="lg" style={{ backgroundColor: '#2E403B', color: 'white' }} onClick={handleStartRecording} disabled={hasFinishedRecording}>
            ...
            <Card className="bg-white shadow-lg">
                ...
                <CardContent>
                    <Textarea
                        placeholder="Tus notas de la sesión..."
            ...
            <Card className="bg-white shadow-lg">
                ...
                <CardContent>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Button variant="secondary" className="w-full sm:w-auto" onClick={handleAttachAudio}>
                            <FileAudio className="mr-2 h-5 w-5" />
                            Adjuntar Audio
                        </Button>
                        <Button variant="secondary" className="w-full sm:w-auto" onClick={handleAttachNotes}>
