...
export default function LoginPage() {
  const handleGoogleLogin = async () => {
    // Usamos el signIn de NextAuth, que se encargará de todo el flujo.
    // Redirigirá a la página de login de Google y luego de vuelta a la app.
